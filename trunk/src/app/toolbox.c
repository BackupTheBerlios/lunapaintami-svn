...
void Init_ToolboxWindow ( )
{
    ...
    offsetWindow = WindowObject,
        MUIA_Window_Title, _(MSG_TOOLBOX_WIN),
        ...
        WindowContents, ( IPTR )VGroup,
            Child, ( IPTR )GroupObject,
                ...
                Child, ( IPTR )TextObject,
                    MUIA_Text_Contents, _(MSG_TOOLBOX_COOR),
                End,
                Child, ( IPTR )HGroup,
                    Child, ( IPTR )TextObject,
                        MUIA_Text_Contents, _(MSG_TOOLBOX_XOFFSET),
                        MUIA_Weight, 50,
                    End,
                ...
                Child, ( IPTR )HGroup,
                    Child, ( IPTR )TextObject,
                        MUIA_Text_Contents, _(MSG_TOOLBOX_YOFFSET),
                        MUIA_Weight, 50,
                    End,
            ...
            Child, ( IPTR )HGroup,
                ...
                Child, ( IPTR )( offsetWindowCancel = SimpleButton ( _(MSG_TOOLBOX_CANCEL) ) ),
            End,
        End,
    End;
    ...
    toolbox = WindowObject,
        MUIA_Window_Title, _(MSG_TOOLBOX),
        MUIA_Window_ScreenTitle, ( IPTR )VERSION,
                            ...
                            Child, ( IPTR )VGroup,
                                ...
                                Child, ( IPTR )HGroup,
                                    ...
                                    Child, ( IPTR )( tbxBtn_line = HGroup,
                                        ...
                                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                                        Child, MUI_NewObject(MUIC_Dtpic,
                                            MUIA_Dtpic_Name, "PROGDIR:data/line.png",
                                            MUIA_Frame, MUIV_Frame_None,
                                        End,
                                    End ),
                                    Child, ( IPTR )( tbxBtn_rectangle = HGroup,
                                        ...
                                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                                        Child, MUI_NewObject(MUIC_Dtpic,
                                            MUIA_Dtpic_Name, "PROGDIR:data/rectangle.png",
                                            MUIA_Frame, MUIV_Frame_None,
                                        End,
                                    End ),
                                    Child, ( IPTR )( tbxBtn_circle = HGroup,
                                        ...
                                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                                        Child, MUI_NewObject(MUIC_Dtpic,
                                            MUIA_Dtpic_Name, "PROGDIR:data/circle.png",
                                            MUIA_Frame, MUIV_Frame_None,
                                        End,
                                    End ),
                                End,
                                Child, ( IPTR )HGroup,
                                    ...
                                    Child, ( IPTR )( tbxBtn_polygon = HGroup,
                                        ...
                                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                                        Child, MUI_NewObject(MUIC_Dtpic,
                                            MUIA_Dtpic_Name, "PROGDIR:data/polygon.png",
                                            MUIA_Frame, MUIV_Frame_None,
                                        End,
                                    End ),
                                    Child, ( IPTR )( tbxBtn_fill = HGroup,
                                        ...
                                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                                        Child, MUI_NewObject(MUIC_Dtpic,
                                            MUIA_Dtpic_Name, "PROGDIR:data/fill.png",
                                            MUIA_Frame, MUIV_Frame_None,
                                        End,
                                    End ),
                                    Child, ( IPTR )( tbxBtn_getbrush = HGroup,
                                        ...
                                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                                        Child, MUI_NewObject(MUIC_Dtpic,
                                            MUIA_Dtpic_Name, "PROGDIR:data/getbrush.png",
                                            MUIA_Frame, MUIV_Frame_None,
                                        End,
                                    End ),
                                    Child, ( IPTR )( tbxBtn_pickcolor = HGroup,
                                        ...
                                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                                        Child, MUI_NewObject(MUIC_Dtpic,
                                            MUIA_Dtpic_Name, "PROGDIR:data/pick_color.png",
                                            MUIA_Frame, MUIV_Frame_None,
                                        End,
                                    End ),
                                End,
                                ...
                                Child, ( IPTR )HGroup,
                                    ...
                                    Child, ( IPTR )(
                                        antiImage = HGroup,
                                            ...
                                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                                            Child, MUI_NewObject(MUIC_Dtpic, 
                                            MUIA_Dtpic_Name, "PROGDIR:data/antialias.png",
                                                MUIA_Frame, MUIV_Frame_None,
                                            End,
                                        End
                                    ),
                                    Child, ( IPTR )(
                                        antiOffImage = HGroup,
                                            ...
                                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                                            Child, MUI_NewObject(MUIC_Dtpic, 
                                            MUIA_Dtpic_Name, "PROGDIR:data/antialias_off.png",
                                                MUIA_Frame, MUIV_Frame_None,
                                            End,
                                        End
                                    ),
                                ...
                                Child, ( IPTR )HGroup,
                                    ...
                                    Child, ( IPTR )(
                                        featherImage = HGroup,
                                            ...
                                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                                            Child, MUI_NewObject(MUIC_Dtpic, 
                                            MUIA_Dtpic_Name, "PROGDIR:data/feathered.png",
                                                MUIA_Frame, MUIV_Frame_None,
                                            End,
                                        End
                                    ),
                                    Child, ( IPTR )(
                                        solidImage  = HGroup,
                                            ...
                                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                                            Child, MUI_NewObject(MUIC_Dtpic, 
                                            MUIA_Dtpic_Name, "PROGDIR:data/solid.png",
                                                MUIA_Frame, MUIV_Frame_None,
                                            End,
                                        End
                                    ),
